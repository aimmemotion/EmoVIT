...
path = '/mnt/data0/Garmin/emo/caption/' + class_name + '/'
filelist = os.listdir(path)

caption_path = '/mnt/data0/Garmin/emo/caption/' + class_name + '/'
annotation_path = '/mnt/data0/Garmin/emo/annotation/' + class_name + '/'
for name in filelist:
    ...
    out_path = "/mnt/data0/Garmin/emo/cap-ano/" + class_name + "/" + name
    f = open(out_path, 'w')
    f.write(out)
    f.close()