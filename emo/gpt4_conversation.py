#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
import requests
import json
import openai
import os
...
#####
with open('/mnt/data0/Garmin/emo/train.json', 'r') as json_file:
...
prompt_path = "/mnt/data0/Garmin/emo/prompt/conversation.txt"
...
path = '/mnt/data0/Garmin/emo/cap-ano/' + class_name + '/'
for i in range(0, 1100):
    print(i)
    name = filelist[i]
    caption_path = "/mnt/data0/Garmin/emo/cap-ano/" + class_name + "/" + name + '.txt'
    ...
    out_path = "/mnt/data0/Garmin/emo/conversation_new100/" + class_name + "/" + name + '.txt'
    f = open(out_path, 'w')
